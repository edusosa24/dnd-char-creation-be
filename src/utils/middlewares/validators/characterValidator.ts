  ...
  const result = await checkSchema(
    {
      ...
      'abilityScore.savingThrows.strength': {
        ...
        isObject: {
          errorMessage: 'abilityScore.savingThrows.strength must be an object',
          bail: true
        }
      },
      'abilityScore.savingThrows.dexterity': {
        ...
        isObject: {
          errorMessage: 'abilityScore.savingThrows.dexterity must be an object',
          bail: true
        }
      },
      'abilityScore.savingThrows.constitution': {
        ...
        notEmpty: {
          errorMessage: 'abilityScore.savingThrows.constitution missing fields',
          bail: true
        },
        isObject: {
          errorMessage:
      ...
      'abilityScore.savingThrows.intelligence': {
        ...
        notEmpty: {
          errorMessage: 'abilityScore.savingThrows.intelligence missing fields',
          bail: true
        },
        isObject: {
          errorMessage:
      ...
      'abilityScore.savingThrows.charisma': {
        ...
        isObject: {
          errorMessage: 'abilityScore.savingThrows.charisma must be an object',
          bail: true
        }
      },
      ...
      'abilityScore.skills.animalHandling': {
        ...
        isObject: {
          errorMessage: 'abilityScore.skills.animalHandling must be an object',
          bail: true
        }
      },
      ...
      'abilityScore.*.*.proficiency': {
        exists: {
          errorMessage:
            'abilityScore.[SAVINGTHROWS/SKILLS].[SAVINGTHROW/SKILL].proficiency is required',
          bail: true
        },
        isBoolean: {
          errorMessage:
            'abilityScore.[SAVINGTHROWS/SKILLS].[SAVINGTHROW/SKILL].proficiency must be true or false'
        }
      },
      'abilityScore.*.*.bonus': {
        exists: {
          errorMessage:
            'abilityScore.[SAVINGTHROWS/SKILLS].[SAVINGTHROW/SKILL].bonus is required',
          bail: true
        },
        isInt: {
          options: { min: 0, max: 99 },
          errorMessage:
            'abilityScore.[SAVINGTHROWS/SKILLS].[SAVINGTHROW/SKILL].bonus must be between 0 and 99',
          bail: true
        }
      },
      /*                                            */
      ...
      'featuresTraitsAndOtherProficiencies.bonds': {
        exists: {
          errorMessage: 'featuresTraitsAndOtherProficiencies.bonds is required',
          bail: true
        },
        isString: {
          errorMessage:
      ...
      'featuresTraitsAndOtherProficiencies.flaws': {
        exists: {
          errorMessage: 'featuresTraitsAndOtherProficiencies.flaws is required',
          bail: true
        },
        isString: {
          errorMessage:
      ...
      'combat.temporaryHitPoints': {
        ...
        isInt: {
          options: { min: 0, max: 9999 },
          errorMessage: 'combat.temporaryHitPoints must be between 0 and 9999',
          bail: true
        }
      },
      'combat.hitDice': {
      ...
      'combat.attacksAndSpellcasting.weapons': {
        ...
        isArray: {
          options: { min: 0, max: 3 },
          errorMessage: 'combat.attacksAndSpellcasting.weapons max length is 3',
          bail: true
        }
      },
      'combat.attacksAndSpellcasting.extra': {
        ...
        isString: {
          errorMessage: 'combat.attacksAndSpellcasting.extra must be a string',
          bail: true
        },
        isLength: {
          options: { max: 250 },
      ...
      'spells.slots.level1.expended': {
        ...
        isInt: {
          options: { min: 0, max: 13 },
          errorMessage: 'spells.slots.level1.expended must be between 0 and 13',
          bail: true
        }
      },
      ...
      'spells.slots.level2.expended': {
        ...
        isInt: {
          options: { min: 0, max: 13 },
          errorMessage: 'spells.slots.level2.expended must be between 0 and 13',
          bail: true
        }
      },
      ...
      'spells.slots.level3.expended': {
        ...
        isInt: {
          options: { min: 0, max: 13 },
          errorMessage: 'spells.slots.level3.expended must be between 0 and 13',
          bail: true
        }
      },
      ...
      'spells.slots.level4.expended': {
        ...
        isInt: {
          options: { min: 0, max: 13 },
          errorMessage: 'spells.slots.level4.expended must be between 0 and 13',
          bail: true
        }
      },
      ...
      'spells.slots.level5.expended': {
        ...
        isInt: {
          options: { min: 0, max: 9 },
          errorMessage: 'spells.slots.level5.expended must be between 0 and 9',
          bail: true
        }
      },
      ...
      'spells.slots.level6.expended': {
        ...
        isInt: {
          options: { min: 0, max: 9 },
          errorMessage: 'spells.slots.level6.expended must be between 0 and 9',
          bail: true
        }
      },
      ...
      'spells.slots.level7.expended': {
        ...
        isInt: {
          options: { min: 0, max: 9 },
          errorMessage: 'spells.slots.level7.expended must be between 0 and 9',
          bail: true
        }
      },
      ...
      'spells.slots.level8.expended': {
        ...
        isInt: {
          options: { min: 0, max: 7 },
          errorMessage: 'spells.slots.level8.expended must be between 0 and 7',
          bail: true
        }
      },
      ...
      'spells.slots.level9.expended': {
        ...
        isInt: {
          options: { min: 0, max: 7 },
          errorMessage: 'spells.slots.level9.expended must be between 0 and 7',
          bail: true
        }
      },
      ...
      'spells.slots.*.*.*.name': {
        exists: {
          errorMessage: 'spells.slots.[LEVEL].[KNOWN].[SPELL].name is required',
          bail: true
        },
        isString: {
          errorMessage:
